...
import { ResponsiveContainer, AreaChart,LineChart, XAxis, Legend, Bar, BarChart, CartesianGrid, YAxis, Tooltip, Area, Line} from 'recharts'
  ...
  return (
    ...
    <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Line yAxisId="right" type="monotone" dataKey="revenue" stroke={palette.primary.main} fillOpacity={1} fill="url(#colorExpenses)" />
        </LineChart>
      </ResponsiveContainer>
